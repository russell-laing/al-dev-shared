...
_Note: rows marked "(auto-located)" below follow this same discovery rule._

| Input | Required | Description |
|-------|----------|-------------|
| `.dev/*-plan-solution-plan.md` | **Yes** | Latest implementation plan (auto-located) |
| `.dev/*-test-test-plan.md` | **Yes** | Latest test plan that drives the TDD cycle (auto-located) |
| `.dev/project-context.md` | No | Project memory and conventions, read when present |
| `.dev/*-develop-code-review.md` | No | Latest review findings for iteration (auto-located when present) |
