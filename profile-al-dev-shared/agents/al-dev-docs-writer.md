...
**Diagrams:** Include Mermaid flowchart for `functional` and `user` audiences if workflow aids understanding. Read `profile-al-dev-shared/markdown/md-mermaid-helper.md` before generating any diagram.
