...
description: >-
  ...
  not integrated into /develop-orchestrate (which uses specialist reviewers
...
This agent is available for standalone use as a general code reviewer. It is not integrated into the /develop-orchestrate review pipeline, which dispatches specialized reviewers (security, patterns, performance) instead.
