---
description: "Research repository structure, local implementation patterns, and extension seams for BC/AL questions. Produces structured findings for /bc-research synthesis."
tools: ["Read", "Glob", "Grep", "mcp__plugin_profile-claude-al-dev_al-mcp-server__<tool>", "mcp__plugin_profile-claude-al-dev_bc-code-intelligence-mcp__<tool>"]
---
...
**Step 3: Strengthen symbol and pattern claims where relevant** — When a conclusion depends on AL object shape, references, or extension seams:

- Prefer available AL semantic navigation when the active environment exposes it
