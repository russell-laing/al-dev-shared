---
description: "Draft a customer-facing reply from internal BC support research findings. Writes the combined findings + reply file. Dispatched by the support-reply skill (reply phase). Pairs with support-researcher."
tools: ["Write"]
---
