...
description: "Draft a customer-facing reply from internal BC support research findings. Writes the combined findings + reply file. Dispatched by the al-dev-support-reply skill (reply phase). Pairs with al-dev-support-researcher."
tools: ["edit"]
---
