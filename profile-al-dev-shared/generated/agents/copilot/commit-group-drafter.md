---
name: "commit-group-drafter"
description: "Git commit group drafter agent. Consumes manifests from commit-analyzer, proposes atomic commit groups, and drafts commit messages. Dispatched by /al-dev-commit (message-drafting phase)."
---
...
- `MANIFESTS` — per-file change summaries from commit-analyzer
...
|-------|----------|--------|-------------|
| MANIFESTS | **Yes** | inline text block (dispatch prompt) | Per-file change summary from commit-analyzer (object IDs, added/removed fields and procedures) |
