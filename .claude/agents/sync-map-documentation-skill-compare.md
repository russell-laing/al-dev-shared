...
description: >-
  Compares skill metadata from skill-metadata.json against docs/skills_map.md
  ...
  "discrepancies": [
    {
      ...
      "detail": "Active skill has no Layer 2 section in docs/skills_map.md"
    }
  ],
...
### Step 2 — Parse docs/skills_map.md

Read `docs/skills_map.md`. Extract:

```bash
grep "^### " docs/skills_map.md
```
