...
flowchart LR
    ...
    subgraph Skills[Skills]
        ...
        skill_al_dev_support[al-dev-support]
        skill_al_dev_ticket[al-dev-ticket]
        skill_commit_recover[commit-recover]
        skill_plan_with_critic_swarm[plan-with-critic-swarm]
    ...
    subgraph Agents[Agents]
        ...
        agent_al_dev_commit_recover_verifier[al-dev-commit-recover-verifier]
    ...
    skill_al_dev_document --> skill_al_dev_develop
    skill_al_dev_explore --> skill_al_dev_interview
    skill_al_dev_explore --> skill_al_dev_plan
    skill_al_dev_explore --> skill_al_dev_ticket
    skill_al_dev_fix --> skill_al_dev_develop
    skill_al_dev_fix --> skill_al_dev_plan
    skill_al_dev_handoff --> skill_al_dev_investigate
    skill_al_dev_handoff --> skill_al_dev_plan
    skill_al_dev_help --> skill_al_dev_commit
    skill_al_dev_help --> skill_al_dev_develop
    skill_al_dev_help --> skill_al_dev_document
    skill_al_dev_help --> skill_al_dev_explore
    skill_al_dev_help --> skill_al_dev_fix
    skill_al_dev_help --> skill_al_dev_interview
    skill_al_dev_help --> skill_al_dev_plan
    skill_al_dev_help --> skill_al_dev_release_notes
    skill_al_dev_help --> skill_al_dev_ticket
    skill_al_dev_investigate --> skill_al_dev_explore
    skill_al_dev_investigate --> skill_al_dev_handoff
    skill_al_dev_investigate --> skill_al_dev_plan
    skill_al_dev_investigate --> skill_al_dev_ticket
    skill_al_dev_perf --> skill_al_dev_plan
    skill_al_dev_plan --> skill_al_dev_explore
    skill_al_dev_plan --> skill_al_dev_perf
    skill_al_dev_review_develop --> skill_al_dev_commit
    skill_al_dev_review_develop --> skill_al_dev_develop
    skill_al_dev_support --> skill_al_dev_ticket
    skill_al_dev_ticket --> skill_al_dev_interview
    skill_al_dev_ticket --> skill_al_dev_plan
    skill_al_dev_ticket --> skill_al_dev_support
    ...
    skill_al_dev_ticket --> agent_al_dev_support_reply_drafter
    skill_al_dev_ticket --> agent_al_dev_support_researcher
    skill_al_dev_ticket --> agent_al_dev_ticket_agent
    skill_commit_recover --> agent_al_dev_commit_recover_verifier
    ...
    skill_al_dev_fix --> knowledge_al_symbol_pre_flight_md
    ...
    skill_al_dev_plan --> knowledge_al_dev_plan_phase_routing_md
    ...
    skill_al_dev_support --> knowledge_ticket_agent_invocation_pattern_md
    ...
    class skill_al_dev_support skillNode
    class skill_al_dev_ticket skillNode
    class skill_commit_recover skillNode
    class skill_plan_with_critic_swarm skillNode
    ...
    class agent_al_dev_commit_recover_verifier agentNode
...
```mermaid
flowchart LR
    skill_al_dev_ticket[al-dev-ticket] --> skill_al_dev_support_reply_drafter[al-dev-support-reply-drafter]
```
...
```mermaid
flowchart LR
    skill_al_dev_investigate[al-dev-investigate] --> skill_al_dev_plan[al-dev-plan]
    skill_al_dev_plan[al-dev-plan] --> skill_al_dev_develop[al-dev-develop]
    skill_al_dev_develop[al-dev-develop] --> skill_al_dev_commit[al-dev-commit]
```
