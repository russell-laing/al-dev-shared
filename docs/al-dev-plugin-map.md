...
> Generated by /analyze-plugin-design on 2026-05-18.
...
- **Explore subagent** — invoked by /al-dev-investigate (×2 parallel), /al-dev-explore (×1), /al-dev-perf (×1); canonical template in `knowledge/explore-subagent-pattern.md`
- **al-dev-developer** — spawned by /al-dev-fix (×1), /al-dev-develop (×2-3); usage pattern varies by context
- **al-dev-solution-architect** — spawned by /al-dev-plan (×2-3 competitive debate) and /al-dev-fix (×1 quick analysis); two structurally different patterns, no shared reference yet
