...
| al-dev-consolidate | Bloat: Phase 2 ~73 lines duplicate patterns now canonical in `consolidate-extraction-patterns.md` | accepted | 2026-06-05 | Cross-reference instead of restating (patterns moved `6cf7e81`) — awaiting implementation |
