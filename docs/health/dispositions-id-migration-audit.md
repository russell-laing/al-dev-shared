...
- Migrated rows: 386
- Rows requiring manual provenance cleanup: 386

## Closes Row Rewrites

- Total rewrite patterns found: 131
- Resolved references: 127
- Unresolvable references: 4

### Resolved Rewrites

| Row | Old Token | New Token |
|-----|-----------|-----------|
| 121 | `closes row 107` | `closes #107` |
| 122 | `closes row 109` | `closes #109` |
| 123 | `closes row 104` | `closes #104` |
| 124 | `closes row 105` | `closes #105` |
| 125 | `closes row 113` | `closes #113` |
| 126 | `closes row 102` | `closes #102` |
| 127 | `closes row 101` | `closes #101` |
| 128 | `closes row 103` | `closes #103` |
| 129 | `closes row 99` | `closes #099` |
| 130 | `closes row 100` | `closes #100` |
| 131 | `closes row 112` | `closes #112` |
| 132 | `closes row 128` | `closes #128` |
| 133 | `closes row 90` | `closes #090` |
| 134 | `closes row 109` | `closes #109` |
| 135 | `closes row 95` | `closes #095` |
| 136 | `closes row 96` | `closes #096` |
| 137 | `closes row 85` | `closes #085` |
| 138 | `closes row 107` | `closes #107` |
| 139 | `closes row 86` | `closes #086` |
| 140 | `closes row 108` | `closes #108` |
| 141 | `closes row 120` | `closes #120` |
| 142 | `closes row 140` | `closes #140` |
| 156 | `closes row 84` | `closes #084` |
| 157 | `closes row 83` | `closes #083` |
| 158 | `closes row 153` | `closes #153` |
| 159 | `closes row 148` | `closes #148` |
| 160 | `closes row 149` | `closes #149` |
| 161 | `closes row 75` | `closes #075` |
| 162 | `closes row 144` | `closes #144` |
| 163 | `closes row 74` | `closes #074` |
| 206 | `closes row 164` | `closes #164` |
| 207 | `closes row 195` | `closes #195` |
| 209 | `closes row 165` | `closes #165` |
| 210 | `closes row 166` | `closes #166` |
| 211 | `closes row 167` | `closes #167` |
| 212 | `closes row 169` | `closes #169` |
| 213 | `closes row 170` | `closes #170` |
| 214 | `closes row 171` | `closes #171` |
| 215 | `closes row 172` | `closes #172` |
| 216 | `closes row 173` | `closes #173` |
| 217 | `closes row 174` | `closes #174` |
| 218 | `closes row 175` | `closes #175` |
| 219 | `closes row 176` | `closes #176` |
| 220 | `closes row 177` | `closes #177` |
| 221 | `closes row 178` | `closes #178` |
| 222 | `closes row 179` | `closes #179` |
| 223 | `closes row 180` | `closes #180` |
| 224 | `closes row 181` | `closes #181` |
| 225 | `closes row 182` | `closes #182` |
| 226 | `closes row 183` | `closes #183` |
| 227 | `closes row 185` | `closes #185` |
| 228 | `closes row 186` | `closes #186` |
| 229 | `closes row 191` | `closes #191` |
| 230 | `closes row 192` | `closes #192` |
| 231 | `closes row 193` | `closes #193` |
| 232 | `closes row 194` | `closes #194` |
| 233 | `closes row 196` | `closes #196` |
| 234 | `closes row 197` | `closes #197` |
| 235 | `closes row 198` | `closes #198` |
| 236 | `closes row 199` | `closes #199` |
| 237 | `closes row 200` | `closes #200` |
| 238 | `closes row 201` | `closes #201` |
| 239 | `closes row 202` | `closes #202` |
| 240 | `closes row 203` | `closes #203` |
| 241 | `closes row 204` | `closes #204` |
| 242 | `closes row 205` | `closes #205` |
| 243 | `closes row 65` | `closes #065` |
| 244 | `closes row 77` | `closes #077` |
| 245 | `closes row 79` | `closes #079` |
| 246 | `closes row 168` | `closes #168` |
| 247 | `closes row 184` | `closes #184` |
| 290 | `closes row 256` | `closes #256` |
| 291 | `closes row 270` | `closes #270` |
| 292 | `closes row 271` | `closes #271` |
| 293 | `closes row 272` | `closes #272` |
| 294 | `closes row 273` | `closes #273` |
| 295 | `closes row 274` | `closes #274` |
| 296 | `closes row 275` | `closes #275` |
| 297 | `closes row 276` | `closes #276` |
| 298 | `closes row 277` | `closes #277` |
| 299 | `closes row 278` | `closes #278` |
| 300 | `closes row 279` | `closes #279` |
| 301 | `closes row 280` | `closes #280` |
| 302 | `closes row 281` | `closes #281` |
| 303 | `closes row 282` | `closes #282` |
| 304 | `closes row 283` | `closes #283` |
| 305 | `closes row 284` | `closes #284` |
| 306 | `closes row 285` | `closes #285` |
| 307 | `closes row 286` | `closes #286` |
| 308 | `closes row 287` | `closes #287` |
| 309 | `closes row 288` | `closes #288` |
| 310 | `closes row 289` | `closes #289` |
| 318 | `closes row 311` | `closes #311` |
| 319 | `closes row 312` | `closes #312` |
| 320 | `closes row 313` | `closes #313` |
| 321 | `closes row 314` | `closes #314` |
| 322 | `closes row 315` | `closes #315` |
| 323 | `closes row 316` | `closes #316` |
| 324 | `closes row 317` | `closes #317` |
| 350 | `closes row 325` | `closes #325` |
| 351 | `closes row 326` | `closes #326` |
| 352 | `closes row 327` | `closes #327` |
| 353 | `closes row 328` | `closes #328` |
| 354 | `closes row 329` | `closes #329` |
| 355 | `closes row 330` | `closes #330` |
| 356 | `closes row 331` | `closes #331` |
| 357 | `closes row 332` | `closes #332` |
| 358 | `closes row 333` | `closes #333` |
| 359 | `closes row 334` | `closes #334` |
| 360 | `closes row 335` | `closes #335` |
| 361 | `closes row 336` | `closes #336` |
| 362 | `closes row 337` | `closes #337` |
| 363 | `closes row 338` | `closes #338` |
| 364 | `closes row 340` | `closes #340` |
| 365 | `closes row 343` | `closes #343` |
| 366 | `closes row 345` | `closes #345` |
| 367 | `closes row 346` | `closes #346` |
| 368 | `closes row 347` | `closes #347` |
| 369 | `closes row 349` | `closes #349` |
| 371 | `closes row 370` | `closes #370` |
| 372 | `closes row 371` | `closes #371` |
| 373 | `closes row 373` | `closes #373` |
| 374 | `closes row 374` | `closes #374` |
| 375 | `closes row 375` | `closes #375` |
| 384 | `closes row 381` | `closes #381` |
| 385 | `closes row 382` | `closes #382` |
| 386 | `closes row 383` | `closes #383` |

### Unresolvable References

| Row | Token | Reason |
|-----|-------|--------|
| 143 | `closes row 149` | Row number out of range |
| 370 | `closes row 372` | Row number out of range |
| 376 | `closes row 377` | Row number out of range |
| 377 | `closes row 379` | Row number out of range |
...
| 187 | unknown | unknown | plugin-health-audit | Naming: structure inverted (object-verb-aspect vs verb-object-aspect) | 2026-06-07 | no live provenance match |
...
| 192 | unknown | unknown | quality-agent-lens-clarity | Structure: pseudo-code block lacks language tag | 2026-06-07 | no live provenance match |
| 193 | unknown | unknown | quality-skill-lens-clarity | Structure: pseudo-code block lacks language tag | 2026-06-07 | no live provenance match |
...
| 230 | unknown | unknown | quality-agent-lens-clarity | Structure: pseudo-code block lacks language tag | 2026-06-07 | no live provenance match |
| 231 | unknown | unknown | quality-skill-lens-clarity | Structure: pseudo-code block lacks language tag | 2026-06-07 | no live provenance match |
...
| 248 | unknown | unknown | plan-health-findings | Bloat: Phase 2 carries 9 named sub-sections with legacy vocabulary notes (residual after `c9a34b3`) | 2026-06-10 | no live provenance match |
| 249 | unknown | unknown | plugin-health-discover | Clarity: cadence guard coverage criterion unstated — how much disposition coverage qualifies as "recorded decisions" | 2026-06-10 | no live provenance match |
| 250 | unknown | unknown | plugin-health-discover | Clarity: Phase 3.1b exclusion rule followed by rationale that reads as contradicting it (introduced by `95b10b3`) | 2026-06-10 | no live provenance match |
| 251 | unknown | unknown | plugin-health-discover | Clarity: Phase 1 commands mix absolute paths and globs; working-directory assumption unclear | 2026-06-10 | no live provenance match |
| 252 | unknown | unknown | plugin-health-discover | Clarity: Phase 2 aggregation text references dispatch concerns, blurring Phase 2/Phase 3 boundary | 2026-06-10 | no live provenance match |
| 253 | unknown | unknown | plugin-health-discover | Description: surface-scoped lens exclusion absent from description | 2026-06-10 | no live provenance match |
| 254 | unknown | unknown | plugin-health-report | Bloat: Phase 1 ~85 lines nested sub-phases 1/1b/1c/1d; staleness gate 8+ conditional branches (open since 2026-06-07; verified 2026-06-10) | 2026-06-10 | no live provenance match |
| 255 | unknown | unknown | plugin-health-discover | Bloat: residual nested structure; Phase 3 still 3.1/3.1b/3.2/3.3 (partially fixed 45372b2/8ce7fa7/a9ef0b3; re-verified 2026-06-10) | 2026-06-10 | no live provenance match |
| 256 | unknown | unknown | record-health-dispositions | Bloat: Phase 2 two separately-stated guard patterns checking related conditions; Phases 3–4 repeat validation blocks | 2026-06-10 | no live provenance match |
| 257 | unknown | unknown | plan-health-findings | Clarity: required-read status of filter-contract reference unstated (mandatory gate vs background) | 2026-06-10 | no live provenance match |
| 258 | unknown | unknown | plan-health-findings | Clarity: Phase 1 stop condition when neither surface returns a dossier path is not an explicit branch | 2026-06-10 | no live provenance match |
| 259 | unknown | unknown | plan-health-findings | Clarity: "live skill caller" undefined in handoff-trace instruction | 2026-06-10 | no live provenance match |
| 260 | unknown | unknown | record-health-dispositions | Clarity: "Batch decisions are fine" vs "Never invent a decision" — justification coverage for grouped batches unstated | 2026-06-10 | no live provenance match |
| 261 | unknown | unknown | plan-health-findings | Clarity: "changed after the dossier was generated" same-day boundary unstated | 2026-06-10 | no live provenance match |
| 262 | unknown | unknown | plan-health-findings | Clarity: parallel-dispatch helper reference is harness-specific token in a neutral skill | 2026-06-10 | no live provenance match |
| 263 | unknown | unknown | plugin-health-report | Clarity: "substantially the same issue" match criterion undefined | 2026-06-10 | no live provenance match |
| 264 | unknown | unknown | plugin-health-report | Clarity: re-flagged-issue suspect rule scope ambiguous — whether it applies only to `fixed` rows is unclear | 2026-06-10 | no live provenance match |
| 265 | unknown | unknown | record-health-dispositions | Clarity: skipping declined/grandfathered/fixed findings — whether global or conditional is unstated | 2026-06-10 | no live provenance match |
| 266 | unknown | unknown | plan-health-findings | Description: --surface/--dimension filtering prominent in body absent from description | 2026-06-10 | no live provenance match |
| 267 | unknown | unknown | plugin-health-report | Description: staleness gate and disposition suppression filter ranking set; description only says "ranks findings" | 2026-06-10 | no live provenance match |
| 268 | unknown | unknown | record-health-dispositions | Clarity: "correctly formatted rows" undefined — no reference to the row schema | 2026-06-10 | no live provenance match |
| 269 | unknown | unknown | record-health-dispositions | Description: `skip` option absent from description decision list | 2026-06-10 | no live provenance match |
| 270 | unknown | unknown | quality-agent-lens-clarity | Clarity: "flag every occurrence" of ambiguous instructions has no operative test; the lens's core check is itself subjective | 2026-06-10 | no live provenance match |
| 271 | unknown | unknown | sync-documentation-maps-collect | Bloat: Phase 1 resume decision tree + Phase 2 polling/error-handling nesting (225 lines) | 2026-06-10 | no live provenance match |
| 272 | unknown | unknown | audit-knowledge-quality | Clarity: Phase 2b live parenthetical "(or files with ordering dependencies)" overlaps the 4+ parallel branch | 2026-06-10 | no live provenance match |
| 273 | unknown | unknown | sync-documentation-maps-apply | Clarity: count-consistency grep uses a whitespace-sensitive literal pattern tied to one table format | 2026-06-10 | no live provenance match |
| 274 | unknown | unknown | sync-documentation-maps-collect | Clarity: Resume/Restart semantics after a checkpoint status of dispatched/complete/skipped not differentiated | 2026-06-10 | no live provenance match |
| 275 | unknown | unknown | sync-documentation-maps | Clarity: Phase 4 checkpoint read-first-then-Edit has no explicit else for the file-absent Write path | 2026-06-10 | no live provenance match |
| 276 | unknown | unknown | sync-documentation-maps-skill-audit | Clarity: "clearly directs writing it" lacks an operative definition of which write verbs count | 2026-06-10 | no live provenance match |
| 277 | unknown | unknown | sync-documentation-maps | Bloat: Phase 0 cadence guard and Phase 4 checkpoint-write block parallel each other (two near-identical checkpoint writes) | 2026-06-10 | no live provenance match |
| 278 | unknown | unknown | sync-documentation-maps-apply | Clarity: required-vs-optional status of the checkpoint-patterns reference file unstated | 2026-06-10 | no live provenance match |
| 279 | unknown | unknown | sync-documentation-maps-collect | Clarity: dispatch step borrows `remaining_lenses` from the health-discover skill | 2026-06-10 | no live provenance match |
| 280 | unknown | unknown | sync-documentation-maps-collect | Clarity: checkpoint-merge instruction splits the field list away from the action | 2026-06-10 | no live provenance match |
| 281 | unknown | unknown | sync-documentation-maps-write | Clarity: regeneration list named as three items but four artifact types are produced | 2026-06-10 | no live provenance match |
| 282 | unknown | unknown | sync-documentation-maps-write | Clarity: count-mismatch recovery describes refresh/restart paths but no criterion for choosing between them | 2026-06-10 | no live provenance match |
| 283 | unknown | unknown | sync-documentation-maps | Clarity: Phase 5 forward-looking --wait advice belongs in the collect skill's argument docs | 2026-06-10 | no live provenance match |
| 284 | unknown | unknown | sync-documentation-maps-agent-audit | Description: omits the script-derived caller cross-reference step (Step 3) | 2026-06-10 | no live provenance match |
| 285 | unknown | unknown | sync-documentation-maps-collect | Description: --all/AUTO_UPDATE bypasses the "asks which maps to update" prompt stated unconditionally | 2026-06-10 | no live provenance match |
| 286 | unknown | unknown | sync-documentation-maps-skill-update | Description: delegation to the shared canonical update procedure not signalled | 2026-06-10 | no live provenance match |
| 287 | unknown | unknown | sync-documentation-maps-apply | Description: per-surface validation/skip independence absent | 2026-06-10 | no live provenance match |
| 288 | unknown | unknown | sync-documentation-maps-write | Description: regeneration failures do not block the commit flow; description implies all four artifacts regenerate | 2026-06-10 | no live provenance match |
| 289 | unknown | unknown | sync-documentation-maps | Description: "Spawns" vs "Dispatches" used interchangeably for the same operation | 2026-06-10 | no live provenance match |
| 290 | unknown | unknown | record-health-dispositions | Bloat: Phase 2 two separately-stated guard patterns checking related conditions; Phases 3–4 repeat validation blocks | 2026-06-10 | no live provenance match |
| 291 | unknown | unknown | quality-agent-lens-clarity | Clarity: "flag every occurrence" of ambiguous instructions has no operative test | 2026-06-10 | no live provenance match |
| 292 | unknown | unknown | sync-documentation-maps-collect | Bloat: Phase 2 polling/error-handling nesting | 2026-06-10 | no live provenance match |
| 293 | unknown | unknown | audit-knowledge-quality | Clarity: Phase 2b "(or files with ordering dependencies)" overlaps the 4+ parallel branch | 2026-06-10 | no live provenance match |
| 294 | unknown | unknown | sync-documentation-maps-apply | Clarity: count-consistency grep uses a whitespace-sensitive literal pattern tied to one table format | 2026-06-10 | no live provenance match |
| 295 | unknown | unknown | sync-documentation-maps-collect | Clarity: Resume/Restart semantics after dispatched/complete/skipped not differentiated | 2026-06-10 | no live provenance match |
| 296 | unknown | unknown | sync-documentation-maps | Clarity: Phase 4 checkpoint read-first-then-Edit has no explicit else for the file-absent Write path | 2026-06-10 | no live provenance match |
| 297 | unknown | unknown | sync-documentation-maps-skill-audit | Clarity: "clearly directs writing it" lacks an operative definition of which write verbs count | 2026-06-10 | no live provenance match |
| 298 | unknown | unknown | sync-documentation-maps | Bloat: Phase 0 cadence guard and Phase 4 checkpoint-write block parallel each other | 2026-06-10 | no live provenance match |
| 299 | unknown | unknown | sync-documentation-maps-apply | Clarity: required-vs-optional status of the checkpoint-patterns reference file unstated | 2026-06-10 | no live provenance match |
| 300 | unknown | unknown | sync-documentation-maps-collect | Clarity: dispatch step borrows `remaining_lenses` from the health-discover skill | 2026-06-10 | no live provenance match |
| 301 | unknown | unknown | sync-documentation-maps-collect | Clarity: checkpoint-merge instruction splits the field list away from the action | 2026-06-10 | no live provenance match |
| 302 | unknown | unknown | sync-documentation-maps-write | Clarity: regeneration list named as three items but four artifact types are produced | 2026-06-10 | no live provenance match |
| 303 | unknown | unknown | sync-documentation-maps-write | Clarity: count-mismatch recovery describes refresh/restart paths but no criterion for choosing | 2026-06-10 | no live provenance match |
| 304 | unknown | unknown | sync-documentation-maps | Clarity: Phase 5 forward-looking --wait advice belongs in the collect skill's argument docs | 2026-06-10 | no live provenance match |
| 305 | unknown | unknown | sync-documentation-maps-agent-audit | Description: omits the script-derived caller cross-reference step (Step 3) | 2026-06-10 | no live provenance match |
| 306 | unknown | unknown | sync-documentation-maps-collect | Description: --all/AUTO_UPDATE bypasses the "asks which maps to update" prompt stated unconditionally | 2026-06-10 | no live provenance match |
| 307 | unknown | unknown | sync-documentation-maps-skill-update | Description: delegation to the shared canonical update procedure not signalled | 2026-06-10 | no live provenance match |
| 308 | unknown | unknown | sync-documentation-maps-apply | Description: per-surface validation/skip independence absent | 2026-06-10 | no live provenance match |
| 309 | unknown | unknown | sync-documentation-maps-write | Description: regeneration failures do not block the commit flow; description implies all four artifacts regenerate | 2026-06-10 | no live provenance match |
| 310 | unknown | unknown | sync-documentation-maps | Description: "Spawns" vs "Dispatches" used interchangeably for the same operation | 2026-06-10 | no live provenance match |
| 311 | unknown | unknown | design-skill-lens-complexity | Clarity: "independently runnable" lacks an operative definition | 2026-06-10 | no live provenance match |
| 312 | unknown | unknown | design-skill-lens-handoff-gaps | Clarity: "orphaned outputs" = "never referenced" but grep scope false-negatives on comments/archived paths | 2026-06-10 | no live provenance match |
| 313 | unknown | unknown | design-skill-lens-near-duplicates | Clarity: "small delta"/"simpler skill" lack numeric bounds around the differ-by-at-most-2 comparison | 2026-06-10 | no live provenance match |
| 314 | unknown | unknown | design-skill-lens-shared-backbone | Clarity: "identical patterns" vs "significantly different" with no threshold or examples | 2026-06-10 | no live provenance match |
| 315 | unknown | unknown | design-skill-lens-surface-placement | Clarity: when a path in a code example counts illustrative vs operative is unexplained | 2026-06-10 | no live provenance match |
| 316 | unknown | unknown | design-skill-lens-preplanning | Clarity: exact-match requirement does not say whether node IDs or label text must match the skill name | 2026-06-10 | no live provenance match |
| 317 | unknown | unknown | design-skill-lens-complexity | Description: says "ranks skills" but ranking arrives as input (phase_counts); the agent evaluates | 2026-06-10 | no live provenance match |
| 318 | unknown | unknown | design-skill-lens-complexity | Clarity: "independently runnable" lacks an operative definition | 2026-06-10 | no live provenance match |
| 319 | unknown | unknown | design-skill-lens-handoff-gaps | Clarity: "orphaned outputs" grep scope false-negatives on comments/archived paths | 2026-06-10 | no live provenance match |
| 320 | unknown | unknown | design-skill-lens-near-duplicates | Clarity: "small delta"/"simpler skill" lack numeric bounds | 2026-06-10 | no live provenance match |
| 321 | unknown | unknown | design-skill-lens-shared-backbone | Clarity: "identical patterns" vs "significantly different" no threshold | 2026-06-10 | no live provenance match |
| 322 | unknown | unknown | design-skill-lens-surface-placement | Clarity: path in code example illustrative vs operative | 2026-06-10 | no live provenance match |
| 323 | unknown | unknown | design-skill-lens-preplanning | Clarity: exact-match node IDs vs label text | 2026-06-10 | no live provenance match |
| 324 | unknown | unknown | design-skill-lens-complexity | Description: "ranks skills" but ranking arrives as input | 2026-06-10 | no live provenance match |
| 325 | unknown | unknown | fix-knowledge-quality | Bloat: Phase 3 dispatch template inlines boilerplate dispatch syntax | 2026-06-10 | no live provenance match |
| 326 | unknown | unknown | audit-knowledge-quality | Clarity: parallel-dispatch helper reference is a harness-specific token in the dispatch step with no fallback | 2026-06-10 | no live provenance match |
| 327 | unknown | unknown | fix-knowledge-quality | Clarity: --auto-fix skip branch has no explicit not-passed branch | 2026-06-10 | no live provenance match |
| 328 | unknown | unknown | fix-knowledge-quality | Clarity: dispatch references a namespaced agent token whose naming scheme is unexplained | 2026-06-10 | no live provenance match |
| 329 | unknown | unknown | audit-knowledge-quality | Description: "offers user-gated fix guidance" reads unconditional; guidance is conditional on user choice | 2026-06-10 | no live provenance match |
| 330 | unknown | unknown | fix-knowledge-quality | Description: hard dependency on audit file existing (Phase 0 stop) absent from description | 2026-06-10 | no live provenance match |
| 331 | unknown | unknown | audit-knowledge-quality | Clarity: "offer targeted fixes" not operationally defined | 2026-06-10 | no live provenance match |
| 332 | unknown | unknown | design-agent-lens-caller-alignment | Clarity: "Working contract" undefined; no signals specified | 2026-06-10 | no live provenance match |
| 333 | unknown | unknown | naming-convention-lens | Clarity: "documented output path"/"mentioned in the body" scope undefined — prose vs frontmatter/code blocks | 2026-06-10 | no live provenance match |
| 334 | unknown | unknown | quality-skill-lens-structure | Clarity: "output files referenced in the body" boundary unclear — frontmatter examples vs prose steps | 2026-06-10 | no live provenance match |
| 335 | unknown | unknown | sync-documentation-maps-agent-audit | Clarity: Step 4 normalization target unstated — does not say which side (script output or map entries) is normalized to (none) | 2026-06-10 | no live provenance match |
| 336 | unknown | unknown | align-harness-repos | Clarity: no branch for exit 0 without PASS output | 2026-06-10 | no live provenance match |
| 337 | unknown | unknown | plugin-health-audit | Clarity: "Never auto-edits source" stated only as a negation | 2026-06-10 | no live provenance match |
| 338 | unknown | unknown | projection-sync | Clarity: Resume logic has no branch for missing or corrupted status field | 2026-06-10 | no live provenance match |
| 339 | unknown | unknown | review-maps | Clarity: "print the maintained async sequence" jargon undefined | 2026-06-10 | no live provenance match |
| 340 | unknown | unknown | align-harness-repos | Bloat: historical name-grandfathering note in skill body (line 25) | 2026-06-10 | no live provenance match |
| 341 | unknown | unknown | design-agent-lens-model-fit | Structure: numbered list at ~lines 29–34 formatted as pseudo-code without a language tag | 2026-06-10 | no live provenance match |
| 342 | unknown | unknown | quality-agent-lens-bloat | Clarity: ">6 sections" AND/OR ">30-line section" threshold logic unspecified | 2026-06-10 | no live provenance match |
| 343 | unknown | unknown | projection-sync | Clarity: "whether any files changed at all" detection command unstated | 2026-06-10 | no live provenance match |
| 344 | unknown | unknown | quality-agent-lens-description | Description: caller-contract check in body not signalled by description | 2026-06-10 | no live provenance match |
| 345 | unknown | unknown | align-harness-repos | Description: forbidden-pattern classes and Phase 3 output rules not verbatim-reconciled | 2026-06-10 | no live provenance match |
| 346 | unknown | unknown | plugin-health-audit | Description: "suggestions-only" vocabulary conflicts with "two-phase internal workflow" in body | 2026-06-10 | no live provenance match |
| 347 | unknown | unknown | projection-sync | Description: says "harness-native projections" but body regenerates agent projections only | 2026-06-10 | no live provenance match |
| 348 | unknown | unknown | review-maps | Description: --no-update preview mode absent from description | 2026-06-10 | no live provenance match |
| 349 | unknown | unknown | design-agent-lens-caller-alignment | Name fit: name emphasizes measured aspect (alignment) rather than lens evaluation action | 2026-06-10 | no live provenance match |
| 350 | unknown | unknown | fix-knowledge-quality | Bloat: Phase 3 dispatch template inlines boilerplate dispatch syntax | 2026-06-10 | no live provenance match |
| 351 | unknown | unknown | audit-knowledge-quality | Clarity: parallel-dispatch helper reference is a harness-specific token in the dispatch step with no fallback | 2026-06-10 | no live provenance match |
| 352 | unknown | unknown | fix-knowledge-quality | Clarity: --auto-fix skip branch has no explicit not-passed branch | 2026-06-10 | no live provenance match |
| 353 | unknown | unknown | fix-knowledge-quality | Clarity: dispatch references a namespaced agent token whose naming scheme is unexplained | 2026-06-10 | no live provenance match |
| 354 | unknown | unknown | audit-knowledge-quality | Description: "offers user-gated fix guidance" reads unconditional; guidance is conditional on user choice | 2026-06-10 | no live provenance match |
| 355 | unknown | unknown | fix-knowledge-quality | Description: hard dependency on audit file existing (Phase 0 stop) absent from description | 2026-06-10 | no live provenance match |
| 356 | unknown | unknown | audit-knowledge-quality | Clarity: "offer targeted fixes" not operationally defined | 2026-06-10 | no live provenance match |
| 357 | unknown | unknown | design-agent-lens-caller-alignment | Clarity: "Working contract" undefined; no signals specified | 2026-06-10 | no live provenance match |
| 358 | unknown | unknown | naming-convention-lens | Clarity: "documented output path"/"mentioned in the body" scope undefined — prose vs frontmatter/code blocks | 2026-06-10 | no live provenance match |
| 359 | unknown | unknown | quality-skill-lens-structure | Clarity: "output files referenced in the body" boundary unclear — frontmatter examples vs prose steps | 2026-06-10 | no live provenance match |
| 360 | unknown | unknown | sync-documentation-maps-agent-audit | Clarity: Step 4 normalization target unstated — does not say which side (script output or map entries) is normalized to (none) | 2026-06-10 | no live provenance match |
| 361 | unknown | unknown | align-harness-repos | Clarity: no branch for exit 0 without PASS output | 2026-06-10 | no live provenance match |
| 362 | unknown | unknown | plugin-health-audit | Clarity: "Never auto-edits source" stated only as a negation | 2026-06-10 | no live provenance match |
| 363 | unknown | unknown | projection-sync | Clarity: Resume logic has no branch for missing or corrupted status field | 2026-06-10 | no live provenance match |
| 364 | unknown | unknown | align-harness-repos | Bloat: historical name-grandfathering note in skill body (line 25) | 2026-06-10 | no live provenance match |
| 365 | unknown | unknown | projection-sync | Clarity: "whether any files changed at all" detection command unstated | 2026-06-10 | no live provenance match |
| 366 | unknown | unknown | align-harness-repos | Description: forbidden-pattern classes and Phase 3 output rules not verbatim-reconciled | 2026-06-10 | no live provenance match |
| 367 | unknown | unknown | plugin-health-audit | Description: "suggestions-only" vocabulary conflicts with "two-phase internal workflow" in body | 2026-06-10 | no live provenance match |
...
| 375 | unknown | unknown | design-skill-lens-handoff-gaps | Caller Alignment: Inputs missing cross-reference step for `.dev/` filenames across skill files | 2026-06-10 | no live provenance match |
| 376 | unknown | unknown | design-skill-lens-preplanning | Caller Alignment: Inputs ambiguous whether agent derives complete pre-planning list or uses `preplanning_skills` as filter | 2026-06-10 | no live provenance match |
| 377 | unknown | unknown | sync-documentation-maps-skill-audit | Caller Alignment: Inputs missing repo root path and directory structure dependency | 2026-06-10 | no live provenance match |
| 378 | unknown | unknown | design-skill-lens-near-duplicates | Caller Alignment: Inputs missing agent_usage_counts structure (agent-type → [skill_names]) for pairing logic | 2026-06-10 | no live provenance match |
| 379 | unknown | unknown | design-skill-lens-shared-backbone | Caller Alignment: Inputs missing agent_usage_counts structure (agent-type → [skills]) | 2026-06-10 | no live provenance match |
| 380 | unknown | unknown | naming-convention-lens | Shared Backbone: dispatch patterns differ across callers (discover vs report) — drift risk | 2026-06-10 | no live provenance match |
| 381 | unknown | unknown | sync-documentation-maps-agent-audit + sync-documentation-maps-skill-audit | Shared Backbone: audit agent dispatch template (run_in_background, run_id, result_dir) undocumented | 2026-06-10 | no live provenance match |
| 382 | unknown | unknown | quality-agent-lens-clarity | Related quality observation: incomplete-conditional detection context unclarified in Inputs | 2026-06-10 | no live provenance match |
| 383 | unknown | unknown | quality-skill-lens-bloat | Related quality observation: Inputs missing note that agent counts ## Phase and ## Step headers | 2026-06-10 | no live provenance match |
| 384 | unknown | unknown | sync-documentation-maps-agent-audit + sync-documentation-maps-skill-audit | Shared Backbone: audit agent dispatch template (run_in_background, run_id, result_dir) undocumented | 2026-06-11 | no live provenance match |
| 385 | unknown | unknown | quality-agent-lens-clarity | Related quality observation: incomplete-conditional detection context unclarified in Inputs | 2026-06-11 | no live provenance match |
| 386 | unknown | unknown | quality-skill-lens-bloat | Related quality observation: Inputs missing note that agent counts ## Phase and ## Step headers | 2026-06-11 | no live provenance match |
