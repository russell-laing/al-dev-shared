...
Found 49 grouped duplicate blocks.
...
- Scope: across files
- Locations:
  - `.claude/agents/quality-agent-lens-bloat.md:43`
  - `.claude/agents/quality-skill-lens-bloat.md:45`
...
- Scope: across files
- Locations:
  - `.claude/agents/quality-agent-lens-clarity.md:15`
  - `.claude/agents/quality-skill-lens-clarity.md:13`
...
- Scope: across files
- Locations:
  - `.claude/agents/quality-agent-lens-structure.md:61`
...
### 30. 9 lines, 2 occurrences

- Scope: across files
- Locations:
  - `.claude/agents/quality-agent-lens-description.md:39`
...
- Scope: across files
- Locations:
  - `.claude/knowledge/health-audit-preconditions.md:54`
  - `.claude/skills/implement-health-plan/SKILL.md:347`
