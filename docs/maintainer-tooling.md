...
| Artifact freshness | `.dev/implement-plugin-health-progress.md` | latest 2026-06-22 |
...
| Artifact freshness | `docs/health/*-*-findings.md` | latest 2026-06-22 |
| Artifact freshness | `docs/health/*-*-friction-findings.md` | latest 2026-06-21 |
| Artifact freshness | `docs/health/*-*-health.md` | latest 2026-06-22 |
| Artifact freshness | `docs/health/dispositions-events/*/*-*.jsonl` | latest 2026-06-22 |
